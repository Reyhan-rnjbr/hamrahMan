...
import Conversetion from "../components/Conversation";
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex justify-between p-4">
        <p className="font-semibold">{t("boxesPage.myInternet")}</p>
        <svg
          fill="none"
          viewBox="0 0 24 24"
      ...
      <div className="flex flex-col gap-4 bg-gray-100 p-4 ">
        ...
        <div>
          {/* {activeInternet==="internet"&&<Internet/>} */}
