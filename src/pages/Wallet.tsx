...
const Wallet=()=> {
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="p-4">
        <p className="font-semibold ">{t("walletPage.wallet")}</p>
      </div>
        ...
        <div className="flex flex-col gap-2 bg-white py-4 px-8">
          <div className="flex flex-col gap-2 justify-center items-center">
            ...
            <p className="font-semibold text-[18px]">
              {t("walletPage.therIsNoMoneyInYourwallet")}
            </p>
          </div>
          <div className="flex flex-col gap-2 bg-gray-100 justify-center items-center p-4 rounded-lg border border-gray-200">
            ...
            <p className="font-semibold text-[14px]">{t("walletPage.increaseStock")}</p>
          </div>
        </div>
        <div className="flex flex-col bg-white h-114 p-4">
            <p className="font-semibold ">{t("walletPage.listBills")}</p>
